...
int main()
{
    srand(time(NULL));
    string difficulty;
    cout << "What difficulty would you like to run the game in?: (I,II,III) ";
    cin >> difficulty;
    int difficult;

    if (difficulty == "I" || difficulty == "i")
        difficult = 3;
    else if (difficulty == "II" || difficulty == "ii")
        difficult = 5;
    else if (difficulty == "III" || difficulty == "iii")
        difficult = 8;
    else
        cout << "That is not a valid difficulty";

    

    
    cGame game(30, difficult + 2);
    game.Run();
    cout << "Game Over!" << endl;
    cout << "\x07";
